...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('dashboards.products') ? 'active' : '' }}" href="#">Thống kê sản phẩm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('dashboards.top10') ? 'active' : '' }}" href="#">Top 10 sản phẩm bán chạy</a>
        </li>
        <li class="nav-item">
