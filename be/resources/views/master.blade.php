...
#sidebar .sidebar-menu > li > a {
    font-size: 18px; /* Tăng kích thước chữ cho các mục menu */
}

/* Điều chỉnh kích thước chữ cho các menu con (sub-menu) */
#sidebar .sub-menu > a {
    font-size: 18px; /* Tăng kích thước chữ cho các mục trong menu con */
}
...
#sidebar .sub-menu .sub > li > a {
    font-size: 16px; /* Đặt kích thước chữ nhỏ hơn cho các mục con trong menu con */
}

/* Tăng kích thước chữ cho các mục không có sub-menu (ví dụ: Quản lý đơn hàng, Phiếu giảm giá, Quản lý liên hệ) */
#sidebar .sidebar-menu > li > a {
    font-size: 18px; /* Kích thước chữ cho các liên kết không có submenu */
}

        /* Sidebar (Aside) */
        #sidebar {
        font-size: 18px; /* Tăng kích thước chữ của sidebar */

            width: 300px; /* Đặt độ rộng sidebar */
            height: 100vh; /* Chiếm toàn bộ chiều cao */
        }

        /* Main content */
        #main-content {
            margin-left: 300px; /* Đẩy nội dung sang phải, tránh bị che khuất */
            width: calc(100% - 300px); /* Chiều rộng của content sẽ là 100% trừ đi chiều rộng sidebar */
        }
    </style>
</head>
