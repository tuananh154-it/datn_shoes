...
class OrderController extends Controller
{
    ...
    {
        // Khởi tạo query cơ bản để lấy tất cả đơn hàng với quan hệ 'customer' và 'voucher'
        $query = Order::with('customer', 'voucher');
    ...
    public function show($id)
{
    ...
    $order = Order::with(['order_details.productDetail.product', 'customer'])->findOrFail($id);
