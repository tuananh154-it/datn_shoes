                  ...
                  <section className="card">
                        ...
                        <table className="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th className="hidden-phone"><i className="fa fa-question-circle"></i> customer_id</th>
                                <th><i className="fa fa-bookmark"></i>product_id</th>
                                <th><i className=" fa fa-edit"></i>comment</th>
                                <th><i className=" fa fa-edit"></i>rating</th>
