...
//     []
//   );
//   console.log("yêu thichs",wishlistProducts)
...
//     const updatedWishlist = JSON.parse(localStorage.getItem("wishlist") || "[]").filter((id: number) => id !== productId);
//     localStorage.setItem("wishlist", JSON.stringify(updatedWishlist));

//     toast.success("Đã xóa khỏi danh sách yêu thích!");
//   };
//   const handleAddToCart = (productId: number, detailId: number | undefined, quantity: number) => {
//     if (!detailId) {
...
//                               <a href="javascript:void(0);" onClick={() => handleRemoveFromWishlist(product.id)}>
