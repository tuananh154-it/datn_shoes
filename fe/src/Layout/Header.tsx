...
const Header = () => {
  ...
  const toggleSearch = (event: React.MouseEvent<HTMLAnchorElement>) => {
    event.preventDefault(); // Ngăn chặn hành động mặc định của thẻ <a>
    setSearchVisible((prevState) => !prevState); // Chuyển đổi trạng thái hiển thị thanh tìm kiếm
  };
    ...
    <>
      <header className="shoes_header shoes_home_header">
        <div className="header_logo col_4 visible-lg d-none">
          <a href="/">
            <img
              src="../public/src/images/shoes_header_logo.png"
              className="img-fluid"
              alt="logo"
            />
          </a>
        ...
        <div className="col_3 visible-lg d-none rown">
