                        ...
                        <div className="navbar-collapse collapse" id="collapseNavbar">
                            <ul className="navbar-nav active">
                                <li className="nav-item ">
                                    <a className="nav-link text-uppercase" href="/">Trang Chủ</a>
                                </li>
                                <MegaMenu />
                                <li className="nav-item dropdown mega-dropdown">
                                    <a className="nav-link text-uppercase" href="/blog">Bài Viết</a>
                                ...
                                <li className="nav-item dropdown mega-dropdown">
                                    <a className="nav-link text-uppercase  dropdown-toggle" href="/contacts">Trang khác</a>
